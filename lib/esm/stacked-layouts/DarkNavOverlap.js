...
export var DarkNavOverlap = function () {
    return (_jsxs("div", __assign({ className: "min-h-1/4 bg-gray-100" }, { children: [_jsxs("div", __assign({ className: "bg-gray-800 pb-32" }, { children: [_jsx(Disclosure, __assign({ as: "nav", className: "bg-gray-800" }, { children: function (_a) {
                            var open = _a.open;
                            return (_jsxs(_Fragment, { children: [_jsx("div", __assign({ className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, { children: _jsx("div", __assign({ className: "border-b border-gray-700" }, { children: _jsxs("div", __assign({ className: "flex items-center justify-between h-16" }, { children: [_jsxs("div", __assign({ className: "flex items-center" }, { children: [_jsx("div", __assign({ className: "shrink-0" }, { children: _jsx(Image, { className: "h-8 w-8", src: LogoWhite, alt: "Workflow" }, void 0) }), void 0), _jsx("div", __assign({ className: "hidden md:block" }, { children: _jsx("div", __assign({ className: "ml-10 flex items-baseline space-x-4" }, { children: navigation.map(function (item) { return (_jsx("a", __assign({ href: item.href, className: classNames(item.current

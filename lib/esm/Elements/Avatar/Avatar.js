...
var AvatarComponent = function (_a) {
    ...
    var topTransform = '-translate-y-1/2 translate-x-1/2';
    var bottomTransform = 'translate-y-1/2 translate-x-1/2';
    return (_jsxs("span", __assign({ className: "inline-block relative", onClick: onClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }, { children: [src ? (_jsx("div", __assign({ className: classNames(size) }, { children: _jsx(Image, { className: classNames(size, shape, 'content-center object-cover'), src: src, layout: "fill", alt: "" }, void 0) }), void 0)) : (_jsx("span", __assign({ className: classNames(size, shape, 'inline-block overflow-hidden bg-gray-100') }, { children: _jsx("svg", __assign({ className: "h-full w-full text-gray-300", fill: "currentColor", viewBox: "0 0 24 24" }, { children: _jsx("path", { d: "M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" }, void 0) }), void 0) }), void 0)), notificationBadge && (_jsx("span", { className: classNames.apply(void 0, __spreadArray(__spreadArray([notificationBadgeSize,

...
export const FullWidthThreeColumn = () => {
  ...
  return (
    <div className="h-96 flex overflow-hidden bg-white">
        ...
        <div className="flex-1 relative z-0 flex overflow-hidden">
          <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none xl:order-last">
            ...
            <div className="absolute inset-0 py-6 px-4 sm:px-6 lg:px-8">
              <div className="h-full border-2 border-blue-200 border-dashed rounded-lg" />
            </div>
            {/* End main area */}
          </main>
          <aside className="hidden relative xl:order-first xl:flex xl:flex-col shrink-0 w-96 border-r border-gray-200">

...
export const BrandedNavCompactWhitePageHeader = () => {
  return (
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  <div className="shrink-0">
                    <Image className="h-8 w-8" src={LogoWhite} alt="Workflow" />
                  </div>
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-indigo-700">
                <div className="flex items-center px-5">
                  ...
                  <button
                    type="button"
                    className="ml-auto bg-indigo-600 shrink-0 p-1 rounded-full text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white"
                  >
                    <span className="sr-only">View notifications</span>
                    <BellIcon className="h-6 w-6" aria-hidden="true" />
                  </button>
